...
function initPelzari() {
  ...
  if ($(".det-carousel").length > 0) {
    ...
    j4.on("slideChangeTransitionEnd", function () {
      var scsc = $(".det-carousel .swiper-slide.swiper-slide-active").data(
          "curtext"
        ),
  ...
  $(".fixed-column").scrollToFixed({
    ...
    limit: function () {
      var a =
        $(".limit-box").offset().top - $(".fixed-column").outerHeight(true);
      return a;
    },
  });
  $(".init_fx-column").scrollToFixed({
    ...
    limit: function () {
      var a =
        $(".limit-box").offset().top - $(".init_fx-column").outerHeight(true);
      return a;
    },
  });
  $(".scroll-fixed-column-content").scrollToFixed({
    ...
    limit: function () {
      var a =
        ...
        $(".scroll-fixed-column-content").outerHeight(true);
      return a;
    },
  });
  $(".fixed-column-filter").scrollToFixed({
    ...
    limit: function () {
      var a =
        $(".limit-box").offset().top -
        $(".fixed-column-filter").outerHeight(true);
      return a;
    },
  });
  //   scroll to------------------
  ...
  function n() {
    if ($(".gallery-items").length) {
      ...
      $(".gallery-filters").on("click", "a.gallery-filter", function (b) {
        ...
        if ($grid > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))
          $(".filt-text span").text(dt2);
...
$("<div class='page-load'><span class='pl-spinner'></span></div>").appendTo(
  "#main"
);
$(
